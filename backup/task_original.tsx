        ...
        >
          ...
          >
            ...
            <View style={styles.fieldSection}>
              <Text style={[styles.fieldLabel, { color: tokens.textSecondary }]}>Task title</Text>
              <View style={[styles.inputContainer, { backgroundColor: tokens.cardItem }]}>
                <TextInput
                  value={title}
            ...
            <View style={styles.rowField}>
              ...
              <View style={[styles.rowInput, { backgroundColor: tokens.cardItem }]}>
