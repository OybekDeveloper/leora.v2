...
type TabName = 'index' | 'finance' | 'planner' | 'insights' | 'more';
type TabLabelKey = 'home' | 'finance' | 'planner' | 'insights' | 'more';
type TabItem = {
  name: TabName;
...
const TABS: readonly TabItem[] = [
  { name: 'index', labelKey: 'home', icon: HomeIcon },
  { name: 'finance', labelKey: 'finance', icon: FinanceIcon },
  { name: 'planner', labelKey: 'planner', icon: PlannerIcon },
  { name: 'insights', labelKey: 'insights', icon: InsightsIcon },
  { name: 'more', labelKey: 'more', icon: MoreIcon },
] as const;
    ...
    >
      ...
      <View style={styles.tabContainer}>
        {TABS.map((tab, index) => {
          ...
          const tabLabel = strings.tabs[tab.labelKey];
